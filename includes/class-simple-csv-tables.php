...
class Simple_CSV_Tables {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Simple_CSV_Tables_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'simple-csv-tables';
	 ...
	 *
	 * - Simple_CSV_Tables_Loader. Orchestrates the hooks of the plugin.
	 * - Simple_CSV_Tables_i18n. Defines internationalization functionality.
	 * - Simple_CSV_Tables_Admin. Defines all hooks for the admin area.
	 * - Simple_CSV_Tables_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Simple_CSV_Tables_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
